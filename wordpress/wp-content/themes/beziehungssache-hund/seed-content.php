            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'field_label' => 'E-Mail',
                        'validation' => true,
                        'validation_text' => 'Bitte gib eine gültige E-Mail-Adresse ein.',
                    ],
                ],
            ],
            [
...
HTML;
    ...
    $content[] = bsh_image_slider_section(
        ...
        [
            ...
            ['slug' => 'mensch-hund-beziehung-naehe-zuhause', 'alt' => 'Nähe und Beziehung zwischen Mensch und Hund zuhause'],
        ]
    );
...
$pages = [
    [
        ...
        'content' => implode("\n\n", [
            ...
            bsh_image_slider_section(
                ...
                [
                    ['slug' => 'mensch-hund-beziehung-naehe-zuhause', 'alt' => 'Mensch und Hund in vertrauter Nähe zuhause', 'eager' => true],
                    ['slug' => 'beziehung-hund-vertrauen-blickkontakt-hundetraining', 'alt' => 'Blickkontakt und Vertrauen im Hundetraining'],
                    ['slug' => 'entspannung-mit-hund-ruhe-und-vertrauen', 'alt' => 'Ruhe und Entspannung mit Hund'],
                ]
            ),
    ...
    [
        ...
        'content' => implode("\n\n", [
            ...
            '<!-- wp:group {"tagName":"section","className":"bsh-section bsh-section--soft","layout":{"type":"constrained"}} --><section class="wp-block-group bsh-section bsh-section--soft"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} --><figure class="wp-block-image size-full"><img src="/wp-content/themes/beziehungssache-hund/assets/optimized/hero-pack-960.webp" alt="DOGSpace Hamburg für Begegnung und Training" /></figure><!-- /wp:image --><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Öffnungszeiten und Einblicke</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Montag bis Freitag von 13:00 bis 18:00 Uhr, nur mit Anmeldung. Aktuelle Einblicke in Formate und Atmosphäre findest du punktuell auch auf <a href="https://instagram.com/cazoobi">Instagram</a>. Öffentliche Preise für DOGSpace Hamburg werden erst dann dargestellt, wenn sie verifiziert und stabil sind. Bis dahin bleibt die Seite bewusst als Orientierungsseite angelegt, damit du schnell einschätzen kannst, ob der Raum und die Art der Begleitung zu euch passen.</p><!-- /wp:paragraph --></section><!-- /wp:group -->',
        ...
        'content' => implode("\n\n", [
            ...
            bsh_image_slider_section(
                ...
                [
                    ...
                    ['slug' => 'mensch-hund-beziehung-naehe-zuhause', 'alt' => 'Nähe und Beziehung von Mensch und Hund zuhause'],
                ]
            ),
    ...
    [
        ...
        'content' => implode("\n\n", [
            ...
            '<!-- wp:group {"tagName":"section","className":"bsh-section bsh-section--soft","layout":{"type":"constrained"}} --><section class="wp-block-group bsh-section bsh-section--soft"><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Deine Rechte und weitere Hinweise</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Du kannst Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung und Widerspruch verlangen, soweit die gesetzlichen Voraussetzungen dafür erfüllt sind. Wenn eine Einwilligung erteilt wurde, kann sie für die Zukunft widerrufen werden.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Vor dem Launch muss dieser Text mit der finalen technischen Konfiguration, dem eingesetzten Formularsystem, eventuellen Tracking-Werkzeugen und dem tatsächlichen Hosting sauber abgeglichen werden. So bleibt die Seite eine belastbare Vorlage und kein unvollständiger Rechtstext.</p><!-- /wp:paragraph --></section><!-- /wp:group -->',
